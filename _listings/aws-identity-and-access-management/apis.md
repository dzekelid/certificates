...
- name: AWS Identity and Access Management API Upload Server Certificate
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/certificates/master/_listings/aws-identity-and-access-management/action-uploadservercertificate-get.md
- name: AWS Identity and Access Management API Upload Signing Certificate
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/certificates/master/_listings/aws-identity-and-access-management/action-uploadsigningcertificate-get.md
x-common:
- type: x-change-log
