...
- name: AWS Database Migration Service API Import Certificate
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/certificates/master/_listings/aws-database-migration-service/action-importcertificate-get.md
x-common:
